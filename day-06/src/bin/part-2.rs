...
fn is_not_marker_start(input: &str) -> IResult<&str, char> {
    let (input, next_14) = peek(take(14usize))(input)?;
    if next_14.chars().all_unique() {
        fail(input)
    } else {
        anychar(input)
    }
...
mod tests {
    ...
    fn part_1_test_input_1() {
        assert_eq!(part_1(TEST_INPUT_1).unwrap(), 19);
    }

    #[test]
    fn part_1_test_input_2() {
        assert_eq!(part_1(TEST_INPUT_2).unwrap(), 23);
    }

    #[test]
    fn part_1_test_input_3() {
        assert_eq!(part_1(TEST_INPUT_3).unwrap(), 23);
    }

    #[test]
    fn part_1_test_input_4() {
        assert_eq!(part_1(TEST_INPUT_4).unwrap(), 29);
    }

    #[test]
    fn part_1_test_input_5() {
        assert_eq!(part_1(TEST_INPUT_5).unwrap(), 26);
    }
}
